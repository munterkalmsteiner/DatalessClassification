 ...
 * yqsong@illinois.edu
 * <p>
 * A node in a concept tree, it extends <code>AbstractTreeNode</code>, has its
 * own props that describes the node (concept) and a list of children connected
 * to the node.
 * 
 */
...
public class ConceptTreeNode extends AbstractTreeNode {
	...
	public void setLabelConcepts(List<String> concepts, List<Double> scores, boolean isBreakConcepts,
